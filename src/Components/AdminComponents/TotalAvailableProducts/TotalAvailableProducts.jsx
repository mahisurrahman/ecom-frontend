        ...
        <div className="border-4 rounded-lg h-[14vh] border-b-4 border-b-seventh">
            <div className="flex items-center justify-between h-full px-5 py-2">
                ...
                <div className="text-right">
                    <h1 className="text-xl font-extrabold text-slate-600">Available Products</h1>
                    <p className="text-xl font-bold mt-1"> =/ <span className="font-normal">{allAvailableProducts.length}</span></p>
                </div>
            </div>
        </div>
    );
